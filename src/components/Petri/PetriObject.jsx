...
import petriDishDefault from "../../img/plastic/80x80_plastic_petri_dish-default.svg";
import petriDishHover from "../../img/plastic/80x80_plastic_petri_dish-hover.svg";


export default function PetriObject(props) {
    const { title, quantity, price } = props;  

    return (
        <>
		{/*ОБЪЕКТ*/}
		<div className="fb-line line-v-catalogy plastic-card" data-id="540">
			<div className="fb-line-top">
				<div className="short-card">
					<div className="short-card-icon">
						<img src={petriDishDefault} 
						className="hidden-main-icon-card" />
						<div className="hidden-icon-card">
							<img src={petriDishHover} />
						</div>
					...
					<div className="short-card-r">
						...
						<div className="short-card-subtitle">(стерильные)</div>
								...
								<table className="card-table">
									<tbody>
										<tr>
											...
											<td rowspan="4">
												<a href="/emarket/basket/put/element/540/?offer_id=435&amp;amount=1" 
													data-id="540"
													data-offer="435" 
													className="card-btn-cart">
													<span className="card-btn-r">
														<span
														className="card-btn_line">
															<span className="card-btn-moblabel">Количество (шт/уп)</span>
														{quantity}
														</span>
														<span className="card-btn_line">
															<span className="card-btn-moblabel">
															Стоимость, руб&nbsp;(с НДС)</span>
														{price}
														</span>
														...
														className="card-btn_line"><span className="card-btn-moblabel">Кат.
															номер</span>TCD010035</span></span><span className="cart-icon"></span></a>
					...
					<div className="card-text card-text--simple card-text--one-column-list card-text--fullwidth text-style">
						<div className="row">
							<div className="col-lg-6 col-md-12">
								...
								<p>· Стерильные<br />· Диаметр: 35 мм<br />· Высота: 10,8 мм<br />· Материал: полипропилен<br />· Фасовка:
									10 шт/ уп</p>
							</div>
						</div>
					</div>
